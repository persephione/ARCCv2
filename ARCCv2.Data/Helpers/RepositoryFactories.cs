...
namespace ARCCv2.Data
{
    ...
    {
        /// <summary>
        /// Constructor that initializes with runtime DDNS repository factories
        /// </summary>
        public RepositoryFactories()
        {
            var tableRepositories = new TableRepositories();
            _repositoryFactories = tableRepositories.GetDictionary();

            var viewRepositories = new ViewRepositories(_repositoryFactories);
            viewRepositories.AddViews();
        }
